...
//                 price: pub.price,
//                 photos: pub.photos,
//                 latPub: pub.coordinates.latitude,
//                 longPub: pub.coordinates.longitude,
...
//     getMap() {
//         fetch(`https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/directions/json?origin=${this.state.latitude},${this.state.longitude}&destination=${this.state.latPub},${this.state.longPub}}&key=AIzaSyALUiIOx7GDeZ2LZNseEaVsjvZHkvac4Nw
//         `,
//         )
//             .then(response => response.json())
...
//                     title={this.state.pub.name}
//                     style={{ width: '80%', height: '600px', border: 0, frameborder: "0" }}
//                     src={`https://www.google.com/maps/embed/v1/directions?key=AIzaSyB1c2Bj57tJ9ny4EJafFlWeosNf3qyYg9M&origin=${this.state.latitude},${this.state.longitude}&destination=${this.state.pub.name}`} >
//                 </iframe>
